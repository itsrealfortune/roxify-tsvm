...
import { getCommandNames } from "../node_modules/typescript-virtual-container/src/commands/registry";
import {
	makeDefaultEnv,
	runCommand,
} from "../node_modules/typescript-virtual-container/src/commands/runtime";
import { spawnNanoEditorProcess } from "../node_modules/typescript-virtual-container/src/modules/shellInteractive";
import { resolvePath } from "../node_modules/typescript-virtual-container/src/modules/shellRuntime";
import {
	buildLoginBanner,
	type LoginBannerState,
} from "../node_modules/typescript-virtual-container/src/SSHMimic/loginBanner";
import { buildPrompt } from "../node_modules/typescript-virtual-container/src/SSHMimic/prompt";
import type {
	CommandResult,
	PasswordChallenge,
	SudoChallenge,
} from "../node_modules/typescript-virtual-container/src/types/commands";
import type VirtualFileSystem from "../node_modules/typescript-virtual-container/src/VirtualFileSystem";
import { VirtualShell } from "../node_modules/typescript-virtual-container/src/VirtualShell";
...
function readLastLogin(username: string): LoginBannerState | null {
	...
	try {
		return JSON.parse(
			virtualShell.vfs.readFile(lastlogPath),
		) as LoginBannerState;
	} catch {
		return null;
	}
